node {
    ...
    stage('Scan image') {
        twistlockScan ca: '', cert: '', dockerAddress: 'unix:///var/run/docker.sock', compliancePolicy: 'warn', ignoreImageBuildTime: false, image: 'demo/bad-dockerfile', key: '', logLevel: 'true', policy: 'warn', requirePackageUpdate: false, timeout: 10
    }
