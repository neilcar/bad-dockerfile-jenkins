node {
    ...
    stage('Scan image') {
        twistlockScan ca: '', cert: '', compliancePolicy: 'high', dockerAddress: 'unix:///var/run/docker.sock', ignoreImageBuildTime: true, image: 'demo/bad-dockerfile:latest', key: '', logLevel: 'true', policy: 'high', requirePackageUpdate: true, timeout: 10
    }
